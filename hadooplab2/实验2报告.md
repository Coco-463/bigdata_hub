...
根据 fd_day_share_interest 表，编写一个MapReduce程序，将过去 7 天的每日收益率mfd_7daily_yield 划分为不同的区间（4到4.5、4.5到5、5到5.5、5.5到6、大于6，五个区间分别标号1、2、3、4、5），统计每个区间下的日均资金流入和流出总量，其中每天的资金流入和流出量是由任务一得出的。
